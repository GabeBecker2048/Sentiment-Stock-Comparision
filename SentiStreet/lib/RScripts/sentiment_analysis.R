...
file_path <- paste("./lib/csv_data/news_data/news_", today_date, ".csv", sep = "")
...
write.csv(sentiment_analysis_top50, paste("./lib/csv_data/sentiment_data/sentiment_", today_date, ".csv", sep = ""))